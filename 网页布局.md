...
.form .submit {
    ...
    height: 31px;
    border: 1px solid rgba(208, 61, 61, 1);
    background: rgba(208, 61, 61, 1) url(../images/search.png) no-repeat center center;
    cursor: pointer;
}
...
.preferential {
    margin-top: 60px;
    border-bottom: 2px solid rgba(227, 226, 226, 1);
    height: 150px;
    text-align: center;
}
    ...
    <div class="header">
        ...
        <div class="container header-bottom clear">
            ...
            <form class="form clear fr">
                <input type="text" placeholder="作品/大师/技艺" class="search" />
